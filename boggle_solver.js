...
var findWords = function(word, y, x, grid, visited, hash, solutionSet) {
...
var isPrefixOrWord = function(word, hash) {
	return hash[word] != undefined;
  
};

var isWord = function(word, hash) {
	return hash[word] == 1;
  
};

var createHashMap = function(dictionary) {
	var dict = {};
...
var convertCaseToLower = function(grid, dict) {
